...
func evalArrayExpression(left, index object.Object) object.Object {
...
func evalHashLiteral(node *ast.HashLiteral, env *object.Environment) object.Object {
	pairs := make(map[object.HashKey]object.HahsPair)
	...
	for keyNode, valueNode := range node.Pairs {
		...
		pairs[hashed] = object.HahsPair{Key: key, Value: value}
	}
